...
![CI](https://github.com/kollorg/voluptates-vel/workflows/CI/badge.svg?branch=master)
[![NPM version](https://img.shields.io/npm/v/@kollorg/voluptates-vel.svg?style=flat)](https://www.npmjs.com/package/@kollorg/voluptates-vel)
...
fastify.register(require('@kollorg/voluptates-vel'), { validate, authenticate })
...
On failed authentication, *@kollorg/voluptates-vel* will call the Fastify
[generic error
handler](https://fastify.dev/docs/latest/Reference/Server/#seterrorhandler) with an error.
*@kollorg/voluptates-vel* sets the `err.statusCode` property to `401`.
...
This is a fallback option to ensure the same behaviour as `@kollorg/voluptates-vel`
version <=5.x.
...
```js
fastify.register(require('@kollorg/voluptates-vel'), {
  validate,
